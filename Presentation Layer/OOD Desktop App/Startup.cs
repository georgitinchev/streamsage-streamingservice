...
namespace DesktopApp
{
    ...
    {
        private readonly string _connectionString = "Server=mssqlstud.fhict.local;Database=dbi524441_streamsage;User Id = dbi524441_streamsage; Password=REMOVED_PASSWORD;TrustServerCertificate=true";
