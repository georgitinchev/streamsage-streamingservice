...
namespace Movie_DB_Filler_API
{
    class Program
    {
        private static string connectionString = "Server=mssqlstud.fhict.local;Database=dbi524441_streamsage;User Id=dbi524441_streamsage;Password=REMOVED_PASSWORD;TrustServerCertificate=true";
        private static string apiKey = "REMOVED_API_KEY";
